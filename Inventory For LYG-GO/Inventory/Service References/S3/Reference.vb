...
Namespace S3
    ...
    Public Interface Service3Soap
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/for_sh_OK", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function for_sh_OK(ByVal forid As Integer, ByVal forusername As String, ByVal forstation As String) As Boolean
        
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/for_sh_read", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function for_sh_read() As System.Data.DataTable
        
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/for_sh_login", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function for_sh_login(ByVal forusername As String, ByVal forpassword As String) As System.Data.DataTable
        
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/for_xbzsh_OK", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function for_xbzsh_OK(ByVal forid As Integer, ByVal forusername As String, ByVal forstation As String) As Boolean
        
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/for_xbzsh_read", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function for_xbzsh_read() As System.Data.DataTable
        
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/for_xbzsh_login", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function for_xbzsh_login(ByVal forusername As String, ByVal forpassword As String) As System.Data.DataTable
    End Interface
    ...
    Partial Public Class Service3SoapClient
        ...
        Public Function for_sh_OK(ByVal forid As Integer, ByVal forusername As String, ByVal forstation As String) As Boolean Implements S3.Service3Soap.for_sh_OK
            Return MyBase.Channel.for_sh_OK(forid, forusername, forstation)
        End Function
        
        Public Function for_sh_read() As System.Data.DataTable Implements S3.Service3Soap.for_sh_read
            Return MyBase.Channel.for_sh_read
        End Function
        
        Public Function for_sh_login(ByVal forusername As String, ByVal forpassword As String) As System.Data.DataTable Implements S3.Service3Soap.for_sh_login
            Return MyBase.Channel.for_sh_login(forusername, forpassword)
        End Function
        
        Public Function for_xbzsh_OK(ByVal forid As Integer, ByVal forusername As String, ByVal forstation As String) As Boolean Implements S3.Service3Soap.for_xbzsh_OK
            Return MyBase.Channel.for_xbzsh_OK(forid, forusername, forstation)
        End Function
        
        Public Function for_xbzsh_read() As System.Data.DataTable Implements S3.Service3Soap.for_xbzsh_read
            Return MyBase.Channel.for_xbzsh_read
        End Function
        
        Public Function for_xbzsh_login(ByVal forusername As String, ByVal forpassword As String) As System.Data.DataTable Implements S3.Service3Soap.for_xbzsh_login
            Return MyBase.Channel.for_xbzsh_login(forusername, forpassword)
        End Function
    End Class
End Namespace

...
Public Class MDIParent1
    ...
    Private Sub 系统注销ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 系统注销ToolStripMenuItem.Click
        End

    End Sub

    Private Sub COA4_Click(sender As Object, e As EventArgs) Handles COA4.Click
        COA_4.Show()
    End Sub
End Class

...
Public Class Seal_A
    ...
    Private Sub 修改记录ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 修改记录ToolStripMenuItem.Click
        ...
        TEMP3.id.Text = ds.Tables("information1").Rows(0).Item("id")

        TEMP3.afcehao.Text = ds.Tables("information1").Rows(0).Item("afce号")
        TEMP3.zichanhao.Text = ds.Tables("information1").Rows(0).Item("资产号")
        TEMP3.zichanfenlei.Text = ds.Tables("information1").Rows(0).Item("资产分类")

        TEMP3.dt1.Text = ds.Tables("information1").Rows(0).Item("资本化日期")

        TEMP3.zichanmingcheng.Text = ds.Tables("information1").Rows(0).Item("资产名称")

        TEMP3.shiyongnianxian.Text = ds.Tables("information1").Rows(0).Item("使用年限")

        TEMP3.guigexinghao.Text = ds.Tables("information1").Rows(0).Item("规格型号")


        TEMP3.shuliang.Text = ds.Tables("information1").Rows(0).Item("数量")

        TEMP3.gongsimingcheng.Text = ds.Tables("information1").Rows(0).Item("公司名称")

        TEMP3.shiyongzhuangtai.Text = ds.Tables("information1").Rows(0).Item("使用状态")

        TEMP3.fapiaoshuliang.Text = ds.Tables("information1").Rows(0).Item("发票数量")

        TEMP3.fujianshuliang.Text = ds.Tables("information1").Rows(0).Item("附件数量")

        TEMP3.shiyongbumen.Text = ds.Tables("information1").Rows(0).Item("使用部门")

        TEMP3.zichanyuanzhi.Text = ds.Tables("information1").Rows(0).Item("资产原值")

        TEMP3.beizhu.Text = ds.Tables("information1").Rows(0).Item("备注")

        TEMP3.fujianleixing.Text = ds.Tables("information1").Rows(0).Item("附件类型")

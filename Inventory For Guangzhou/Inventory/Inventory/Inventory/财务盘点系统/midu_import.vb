...
Public Class midu_import
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        Try
            Dim da As New SqlDataAdapter("Select * from midu_wuliaobianma", objconnection)
            ...
            objdataadapter.SelectCommand.CommandText = "delete midu_wuliaobianma "
            ...
            objdataadapter.SelectCommand = New SqlCommand
            objdataadapter.SelectCommand.Connection = objconnection
            objdataadapter.SelectCommand.CommandText = "select * from midu_wuliaobianma"
            If objconnection.State = ConnectionState.Closed Then
                objconnection.Open()
            End If

...
Public Class PrintSomething
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        End If
        If seldel.Checked = False Then
            objdataadapterforprint.SelectCommand.CommandText = objdataadapterforprint.SelectCommand.CommandText & "and 删除标志 is null order by id desc"
        End If

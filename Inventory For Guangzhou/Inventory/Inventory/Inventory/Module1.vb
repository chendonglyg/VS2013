...
Module Module1
    ...
    'Public objconnection As New SqlConnection("Data Source= 10.229.56.14,1433;Initial Catalog = inventory;User ID=sa; Password=gz.1234")

    'Public objconnection As New SqlConnection("Data Source= 10.229.17.10,1433;Initial Catalog = inventory;User ID=sa; Password=chen dong")

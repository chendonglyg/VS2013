...
Public Class MainWork
    ...
    Dim objconnection = New SqlClient.SqlConnection("Data Source= " & Trim("10.229.17.10") & "," & Trim("1433") & ";Initial Catalog = package;User ID=" & "sa" & "; Password=" & "chen dong")
    ...
    Private Sub filldata()
        ...
        objdataadapter.SelectCommand.CommandText = "select * from TRUCK_QUEUE WHERE 可进厂=1 and 司机二代证<>''"

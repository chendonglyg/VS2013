...
Public Class PrintSomething
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If gq.Checked = True Then
            objdataadapterforprint.SelectCommand.CommandText = "select  * from TZ_InventoryData where (盘点时间 between '" & dt11.Value & " ' and  ' " & dt12.Value & "') and rtrim(所属罐区) = '泰州粮油罐区' "
        End If
        ...
        Try
            ...
            objdataadapterforprint.Fill(objdatasetforprint, "TZ_InventoryData")
            objdataviewforprint = New DataView(objdatasetforprint.Tables("TZ_InventoryData"))
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If gq.Checked = True Or yxgq.Checked = True Then
            ...
            oRpt.SetDataSource(objdatasetforprint.Tables("TZ_InventoryData"))

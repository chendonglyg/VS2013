...
Public Class Calculate_Users
    ...
    Private Sub filldatasetandview()
        ...
        objdataadapter.SelectCommand.CommandText = "select * from TZ_InventoryUsers  "

        If objconnection.State = ConnectionState.Closed Then
            objconnection.Open()
        End If
        objdataset = New DataSet
        objdataadapter.Fill(objdataset, "TZ_InventoryUsers")
        forreport = objdataadapter '供打印使用
        objdataview = New DataView(objdataset.Tables("TZ_InventoryUsers"))
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Else
            ...
            objdataadapter.SelectCommand = New SqlCommand
            objdataadapter.SelectCommand.Connection = objconnection
            objdataadapter.SelectCommand.CommandText = "select * from TZ_InventoryUsers where username = '" & Trim(TextBox114.Text) & "'"
            ...
            Else
                ...
                If (TextBox114.Text.Length > 0) And (TextBox113.Text.Length > 0) Then
                    ...
                    objcommand.CommandText = "insert into TZ_InventoryUsers (username,password,station,注册时间) values (@username,@password,@station,@注册时间) "
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        ...
        objdataadapter.SelectCommand = New SqlCommand
        objdataadapter.SelectCommand.Connection = objconnection
        objdataadapter.SelectCommand.CommandText = "select * from TZ_InventoryUsers where username = '" & Trim(changepassword.Text) & "' and password ='" & Trim(TextBox1.Text) & "'"
        ...
        If objdataview.Count > 0 Then
            ...
            objcommand0.CommandText = "update TZ_InventoryUsers set password = '" & Trim(TextBox3.Text) & "' where username ='" & Trim(changepassword.Text) & "'"
            If objconnection.State = ConnectionState.Closed Then
                objconnection.Open()
            End If
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        If TextBox113.Text.Length > 0 Then
            ...
            objcommandpassword.CommandText = "Update TZ_InventoryUsers set  password=@password where id=" & Val(TextBox115.Text)

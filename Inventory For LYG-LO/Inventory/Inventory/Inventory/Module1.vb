...
Module Module1
    ...
    Public objconnection As New SqlConnection("Data Source= 218.92.115.4,1433;Initial Catalog = inventory;User ID=sa; Password=chen dong")
    Public connforcangku As New SqlConnection("Data Source= 218.92.115.4,1433;Initial Catalog = package;User ID=sa; Password=chen dong")

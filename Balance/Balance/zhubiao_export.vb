...
Public Class zhubiao_export
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Balance.zhubiao_export.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedzhubiao_export
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As zhubiao_export = New zhubiao_export()
        rpt.Site = Me.Site
        Return rpt
    End Function

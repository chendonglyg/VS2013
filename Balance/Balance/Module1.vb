...
Module Module1
    ...
    Public objconnection, objconnectionmove As SqlConnection
    'Public objconnectionmove As New SqlConnection("Data Source= 218.92.113.9,1433;Initial Catalog = movestore;User ID=sa; Password=chen dong")

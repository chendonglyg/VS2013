...
Public Class MoveStore
    ...
    Private Sub ToolStripButton7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton7.Click
        Try
            ...
            If xbz.Checked = True Then
                objdataadapter.SelectCommand.CommandText = "select * from trade  where mark is null and finaldatetime2 between '" & dt11.Value & " ' and  ' " & dt12.Value & "' "

            End If

            If bq.Checked = True Then
            ...
            If bq.Checked = False And xbz.Checked = False Then
                objdataadapter.SelectCommand.CommandText = "select * from trade  where finaldatetime2 between '" & dt11.Value & " ' and  ' " & dt12.Value & "' "
    ...
    Private Sub ziduan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ziduan.Click

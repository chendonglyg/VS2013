...
Public Class zhangjiagang
    ...
    <WebMethod()> _
    Public Function Calculate(ByVal gaodu2 As Single, ByVal gaodu3 As Single, ByVal youwen2 As Single, ByVal youwen3 As Single, ByVal yp As String, ByVal wlbm As String, ByVal pandianren As String, ByVal jianpanren As String, ByVal guanqu As String, ByVal beizhu As String, ByVal guanhao_w As String, ByVal gaodu_w As Single, ByVal youwen_w As Single, ByVal qiwen_w As Single, ByVal bzmd_w As Single, ByVal bzwd_w As Single, ByVal bhxs_w As Single) As Single


       
        guanhao = guanhao_w
        gaodu = (Val(gaodu_w) + Val(gaodu2) + Val(gaodu3)) / 3

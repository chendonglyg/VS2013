Public Class QZ_Mission
    ...
    Private Sub btn2_Click(sender As Object, e As EventArgs) Handles btn2.Click
        ...
        Else
            ...
            objdataadapter.SelectCommand.CommandText = "delete QZ_InventoryWork "
            ...
            '---------------------------------------------------------------
            Dim da As New SqlClient.SqlDataAdapter("Select * from QZ_InventoryWork", objconnection)
            Dim MyCB As SqlClient.SqlCommandBuilder = New SqlClient.SqlCommandBuilder(da)
            Dim ds As New DataSet()
            da.MissingSchemaAction = MissingSchemaAction.AddWithKey
            da.Fill(ds, "QZ_InventoryWork")
            ...
            For c = a To b
                myRow = ds.Tables("QZ_InventoryWork").NewRow()
                ...
                ds.Tables("QZ_InventoryWork").Rows.Add(myRow)
            ...
            objdataadapter.SelectCommand.CommandText = "select * from QZ_InventoryWork "
            If objconnection.State = ConnectionState.Closed Then
                objconnection.Open()
            End If
    ...
    Private Sub 保存数据ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 保存数据ToolStripMenuItem.Click
        ...
        Dim SCB1 As SqlClient.SqlCommandBuilder = New SqlClient.SqlCommandBuilder(objdataadapter)

        objdataadapter.Update(objdataset.Tables("QZ_InventoryWork"))
    ...
    Private Sub UpdateDataToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles UpdateDataToolStripMenuItem.Click
        On Error Resume Next
        Dim SCB2 As SqlClient.SqlCommandBuilder = New SqlClient.SqlCommandBuilder(objdataadapter2)

        objdataadapter2.Update(objdataset2.Tables("QZ_InventoryDensity"))
    ...
    Private Sub btn4_Click(sender As Object, e As EventArgs) Handles btn4.Click
        Try
            ...
            Else
                ...
                objdataadapter2.SelectCommand.CommandText = "delete QZ_InventoryDensity "
                ...
                Dim da As New SqlClient.SqlDataAdapter("Select * from QZ_InventoryDensity", objconnection)
                Dim MyCB As SqlClient.SqlCommandBuilder = New SqlClient.SqlCommandBuilder(da)
                Dim ds As New DataSet()
                da.MissingSchemaAction = MissingSchemaAction.AddWithKey
                da.Fill(ds, "QZ_InventoryDensity")
                Dim myRow As DataRow
                ...
                For c = a To b
                    myRow = ds.Tables("QZ_InventoryDensity").NewRow()
                    ...
                    ds.Tables("QZ_InventoryDensity").Rows.Add(myRow)
                ...
                da.Update(ds, "QZ_InventoryDensity")
                MyCB = Nothing
                ds = Nothing
                da = Nothing
                ...
                objdataadapter2.SelectCommand = New SqlClient.SqlCommand
                objdataadapter2.SelectCommand.Connection = objconnection
                objdataadapter2.SelectCommand.CommandText = "select * from QZ_InventoryDensity"
                If objconnection.State = ConnectionState.Closed Then
                    objconnection.Open()
                End If
                objdataset2 = New DataSet
                objdataadapter2.Fill(objdataset2, "QZ_InventoryDensity")
                objdataview2 = New DataView(objdataset2.Tables("QZ_InventoryDensity"))

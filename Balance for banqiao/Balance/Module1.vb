...
Module Module1
    ...
    Public objconnectionmove As New SqlConnection("Data Source= 218.92.115.4,1433;Initial Catalog = movestore;User ID=sa; Password=chen dong")
    ''Public objconn As New SqlConnection("Data Source= 10.229.17.6,1433;Initial Catalog = toledo;User ID=sa; Password=chen dong")

...
Public Class LoginForm1
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        ''objconnection = New SqlConnection("Data Source= 218.92.115.6;Initial Catalog = toledo;User ID=sa; Password=chen dong")

        ''objconnection = New SqlConnection("Data Source= " & dangqianlianjie & ";Initial Catalog = toledo;User ID=sa; Password=chen dong")



        objconn = objconnection '让连接地址和登陆框上输入的统一

...
Public Class fahuodanweihuoming
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Balance.fahuodanweihuoming.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfahuodanweihuoming
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fahuodanweihuoming = New fahuodanweihuoming()
        rpt.Site = Me.Site
        Return rpt
    End Function

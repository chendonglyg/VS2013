...
Public Class huowufenleitongji
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Balance.huowufenleitongji.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedhuowufenleitongji
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As huowufenleitongji = New huowufenleitongji()
        rpt.Site = Me.Site
        Return rpt
    End Function

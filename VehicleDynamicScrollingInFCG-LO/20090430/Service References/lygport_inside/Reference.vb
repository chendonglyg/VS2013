...
Namespace lygport_inside
    
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute(ConfigurationName:="lygport_inside.Service1Soap")>  _
    Public Interface Service1Soap
        ...
        Function HelloWorld(ByVal request As lygport_inside.HelloWorldRequest) As lygport_inside.HelloWorldResponse
        ...
        Function GetInRecord(ByVal request As lygport_inside.GetInRecordRequest) As lygport_inside.GetInRecordResponse
        
        'CODEGEN: 命名空间 http://tempuri.org/ 的元素名称 cryptogram 以后生成的消息协定未标记为 nillable
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/InsertConsignVehicle", ReplyAction:="*")>  _
        Function InsertConsignVehicle(ByVal request As lygport_inside.InsertConsignVehicleRequest) As lygport_inside.InsertConsignVehicleResponse
        
        'CODEGEN: 命名空间 http://tempuri.org/ 的元素名称 cryptogram 以后生成的消息协定未标记为 nillable
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/UpdateConsignVehicle", ReplyAction:="*")>  _
        Function UpdateConsignVehicle(ByVal request As lygport_inside.UpdateConsignVehicleRequest) As lygport_inside.UpdateConsignVehicleResponse
    End Interface
    ...
    Partial Public Class HelloWorldRequest
        ...
        Public Body As lygport_inside.HelloWorldRequestBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As lygport_inside.HelloWorldRequestBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class HelloWorldResponse
        ...
        Public Body As lygport_inside.HelloWorldResponseBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As lygport_inside.HelloWorldResponseBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class GetInRecordRequest
        ...
        Public Body As lygport_inside.GetInRecordRequestBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As lygport_inside.GetInRecordRequestBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class GetInRecordResponse
        ...
        Public Body As lygport_inside.GetInRecordResponseBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As lygport_inside.GetInRecordResponseBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class InsertConsignVehicleRequest
        ...
        Public Body As lygport_inside.InsertConsignVehicleRequestBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As lygport_inside.InsertConsignVehicleRequestBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class InsertConsignVehicleResponse
        ...
        Public Body As lygport_inside.InsertConsignVehicleResponseBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As lygport_inside.InsertConsignVehicleResponseBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class UpdateConsignVehicleRequest
        ...
        Public Body As lygport_inside.UpdateConsignVehicleRequestBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As lygport_inside.UpdateConsignVehicleRequestBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class UpdateConsignVehicleResponse
        ...
        Public Body As lygport_inside.UpdateConsignVehicleResponseBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As lygport_inside.UpdateConsignVehicleResponseBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Public Interface Service1SoapChannel
        Inherits lygport_inside.Service1Soap, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>  _
    Partial Public Class Service1SoapClient
        Inherits System.ServiceModel.ClientBase(Of lygport_inside.Service1Soap)
        Implements lygport_inside.Service1Soap
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function lygport_inside_Service1Soap_HelloWorld(ByVal request As lygport_inside.HelloWorldRequest) As lygport_inside.HelloWorldResponse Implements lygport_inside.Service1Soap.HelloWorld
            Return MyBase.Channel.HelloWorld(request)
        End Function
        
        Public Function HelloWorld() As String
            Dim inValue As lygport_inside.HelloWorldRequest = New lygport_inside.HelloWorldRequest()
            inValue.Body = New lygport_inside.HelloWorldRequestBody()
            Dim retVal As lygport_inside.HelloWorldResponse = CType(Me,lygport_inside.Service1Soap).HelloWorld(inValue)
            Return retVal.Body.HelloWorldResult
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function lygport_inside_Service1Soap_GetInRecord(ByVal request As lygport_inside.GetInRecordRequest) As lygport_inside.GetInRecordResponse Implements lygport_inside.Service1Soap.GetInRecord
        ...
        Public Function GetInRecord(ByVal cryptogram As String, ByVal vehicle As String, ByVal externo As String, <System.Runtime.InteropServices.OutAttribute()> ByRef in_date As String, <System.Runtime.InteropServices.OutAttribute()> ByRef PictureGate() As Byte, <System.Runtime.InteropServices.OutAttribute()> ByRef PictureVehicle() As Byte, <System.Runtime.InteropServices.OutAttribute()> ByRef strErr As String, <System.Runtime.InteropServices.OutAttribute()> ByRef phone_no As String) As String
            Dim inValue As lygport_inside.GetInRecordRequest = New lygport_inside.GetInRecordRequest()
            inValue.Body = New lygport_inside.GetInRecordRequestBody()
            inValue.Body.cryptogram = cryptogram
            inValue.Body.vehicle = vehicle
            inValue.Body.externo = externo
            Dim retVal As lygport_inside.GetInRecordResponse = CType(Me,lygport_inside.Service1Soap).GetInRecord(inValue)
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function lygport_inside_Service1Soap_InsertConsignVehicle(ByVal request As lygport_inside.InsertConsignVehicleRequest) As lygport_inside.InsertConsignVehicleResponse Implements lygport_inside.Service1Soap.InsertConsignVehicle
        ...
        Public Function InsertConsignVehicle(ByVal cryptogram As String, ByVal vehicle As String, ByVal phone_no As String) As String
            Dim inValue As lygport_inside.InsertConsignVehicleRequest = New lygport_inside.InsertConsignVehicleRequest()
            inValue.Body = New lygport_inside.InsertConsignVehicleRequestBody()
            inValue.Body.cryptogram = cryptogram
            inValue.Body.vehicle = vehicle
            inValue.Body.phone_no = phone_no
            Dim retVal As lygport_inside.InsertConsignVehicleResponse = CType(Me,lygport_inside.Service1Soap).InsertConsignVehicle(inValue)
            Return retVal.Body.InsertConsignVehicleResult
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function lygport_inside_Service1Soap_UpdateConsignVehicle(ByVal request As lygport_inside.UpdateConsignVehicleRequest) As lygport_inside.UpdateConsignVehicleResponse Implements lygport_inside.Service1Soap.UpdateConsignVehicle
        ...
        Public Function UpdateConsignVehicle(ByVal cryptogram As String, ByVal vehicle As String) As String
            Dim inValue As lygport_inside.UpdateConsignVehicleRequest = New lygport_inside.UpdateConsignVehicleRequest()
            inValue.Body = New lygport_inside.UpdateConsignVehicleRequestBody()
            inValue.Body.cryptogram = cryptogram
            inValue.Body.vehicle = vehicle
            Dim retVal As lygport_inside.UpdateConsignVehicleResponse = CType(Me,lygport_inside.Service1Soap).UpdateConsignVehicle(inValue)

...
Public Class MDIMain
    ...
    Private Sub 罐区计算器ToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles 罐区计算器ToolStripMenuItem.Click
        OFFLINE.Show()
    End Sub

    Private Sub 密度参数ToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles 密度参数ToolStripMenuItem.Click
        JUSTCODE.Show()

    End Sub

    Private Sub 货品维护ToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles 货品维护ToolStripMenuItem.Click
        Mission.Show()
    End Sub

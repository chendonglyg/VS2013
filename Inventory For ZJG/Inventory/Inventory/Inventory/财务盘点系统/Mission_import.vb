    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        Try
            ...
            Else
                ...
                End If
                '---------------------------------------------------------------
                Dim da As New SqlDataAdapter("Select * from midu_zjg", objconnection)
                ...
                objdataadapter.SelectCommand.CommandText = "delete midu_zjg where 所属罐区='" & ssgq & "'"
                ...
                objdataadapter.SelectCommand = New SqlCommand
                objdataadapter.SelectCommand.Connection = objconnection
                objdataadapter.SelectCommand.CommandText = "select * from midu_zjg where 所属罐区='" & ssgq & "'"
                If objconnection.State = ConnectionState.Closed Then
                    objconnection.Open()
                End If
